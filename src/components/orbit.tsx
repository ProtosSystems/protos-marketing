...
export const Orbit = ({
  ...
  return (
    ...
    >
      <div
        aria-hidden="true"
        className="absolute -inset-16 rounded-full bg-[repeating-linear-gradient(45deg,rgba(11,31,59,0.035)_0px,rgba(11,31,59,0.035)_2px,transparent_2px,transparent_8px)] dark:bg-[repeating-linear-gradient(45deg,rgba(255,255,255,0.05)_0px,rgba(255,255,255,0.05)_2px,transparent_2px,transparent_8px)]"
      />
      {/* Orbital path */}
      <div
