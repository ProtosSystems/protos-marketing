        ...
        <div key="obj1" className="relative flex items-center justify-center">
          ...
          <div className="absolute -top-5 left-4">
            <div className="flex gap-1">
              ...
              <div className="rounded-r-full bg-white py-0.5 pr-1.5 pl-1 text-xs whitespace-nowrap text-[#09162A] ring-1 ring-gray-300 dark:bg-[#0B1F3B] dark:text-[#E5E7EB]">
                Restated
              </div>
            </div>
          </div>
        ...
        <div key="obj2" className="relative flex items-center justify-center">
          ...
          <div className="absolute -top-5 left-4">
            <div className="flex gap-1">
              ...
              <div className="rounded-r-full bg-white py-0.5 pr-1.5 pl-1 text-[10px] leading-4 whitespace-nowrap text-[#09162A] ring-1 ring-gray-300 dark:bg-[#0B1F3B] dark:text-[#E5E7EB]">
                Temporal
              </div>
            </div>
          </div>
        ...
        <div key="obj4" className="relative flex items-center justify-center">
          ...
          <div className="absolute -top-5 left-4">
            <div className="flex gap-1">
              ...
              <div className="rounded-r-full bg-white py-0.5 pr-1.5 pl-1 text-xs text-[#09162A] ring-1 ring-gray-300 dark:bg-[#0B1F3B] dark:text-[#E5E7EB]">
                Reconciled
              </div>
            </div>
          </div>
      ...
      <div className="relative flex h-48 w-48 items-center justify-center">
        <div className="rounded-full p-1 ring-1 ring-black/10">
          <div className="relative z-10 flex size-20 items-center justify-center rounded-full bg-white shadow-[inset_0px_-15px_20px_rgba(0,0,0,0.1),0_7px_10px_0_rgba(0,0,0,0.15)] ring-1 ring-black/20 dark:bg-[color:var(--color-primary)] dark:ring-white/15">
            <span className="h3 font-regular text-2xl tracking-tight text-[color:var(--color-deep-steel-blue)] dark:text-white">
