...
const variants = {
  primary: clsx(
    ...
    'data-disabled:bg-[color:var(--color-primary)] data-disabled:opacity-40 hover:bg-[color:var(--color-deep-steel-blue)]',
    'dark:bg-[color:var(--color-mist-300)] dark:text-[color:var(--color-mist-950)] dark:hover:bg-[color:var(--color-mist-200)]',
  ),
  secondary: clsx(
    ...
    'data-disabled:bg-white/70 data-disabled:opacity-40 hover:bg-white/85',
    'dark:bg-white/12 dark:text-white dark:ring-white/20 dark:hover:bg-white/18',
  ),
  outline: clsx(
    ...
    'data-disabled:bg-transparent data-disabled:opacity-40 hover:bg-[color:var(--color-soft-gray)]',
    'dark:text-white dark:ring-white/20 dark:hover:bg-white/10',
  ),
}
